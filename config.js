...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐹𝛥𝐺𝑈 𝐵𝛩𝑇',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐹𝛥𝐺𝑈 𝐵𝛩𝑇;ꜰᴀᴅʜɪʟ;919995886562;https://i.imgur.com/Qui6BQ8.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝐹𝛥𝐺𝑈 𝐵𝛩𝑇;ꜰᴀᴅʜɪʟ;https://i.imgur.com/Qui6BQ8.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐹𝛥𝐺𝑈 𝐵𝛩𝑇;⚡' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '919995886562,0',
       DEBUG: DEBUG
};
